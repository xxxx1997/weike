...
<ul> 
                			<li><a href="index.php?r=login/regist">无账号？现在去注册</a></li>
</ul>
</nav>
</div>
            </header>
...
?>
     <?php $form = ActiveForm::begin([
		"action" => '/frontend/web/index.php?r=login/login_do',]); ?> 
                            <input type="hidden" name="formhash" id="formhash" value="ce9abd">
<input type="hidden" name="hdn_refer" id="hdn_refer" value="http://www.wei.com/">
...
<script type="text/javascript">
var uid='';
var xyq = "6ed1raje3sr0gomd1bc7drp531";
 //js异步加载
