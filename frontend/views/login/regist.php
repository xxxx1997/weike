...
?>
     <?php $form = ActiveForm::begin([
		"action" => '/frontend/web/index.php?r=login/regist_do',]); ?> 
...
ajax="index.php?do=ajax&view=code&txt_code=" >
 			...
 			<div id="show_secode_menu_content" class="hidden secode_box">
 				...
 				<?= $form->field($model, 'a')->widget(Captcha::className(), [
                    'template' => '<div class="row" style="margin-top:px;margin-left:px;">{image}</div>',
                ]) ?>
 				<a class="font14" href="#" onclick="document.getElementById('secode_img').src='secode_show.php?sid='+Math.random(); return false;"></a>
