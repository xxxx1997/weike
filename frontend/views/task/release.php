        ...
        <div class="content_d">
            ...
            <div class="step1_detail">
                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                    <ul>
                                                <li>
                            <a href="index.php?do=release&pub_mode=professional&model_id=1" class="selected"><span class="icon32 task_model">单人悬赏</span><em>单人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?do=release&pub_mode=professional&model_id=3" ><span class="icon32 task_model">计件悬赏</span><em>计件悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?do=release&pub_mode=professional&model_id=2" ><span class="icon32 task_model">多人悬赏</span><em>多人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?do=release&pub_mode=professional&model_id=4" ><span class="icon32 task_model">普通招标</span><em>普通招标</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
                            <a href="index.php?do=release&pub_mode=professional&model_id=5" ><span class="icon32 task_model">订金招标</span><em>订金招标</em><span class="arrow_b"></span></a>
                        </li>
