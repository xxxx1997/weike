                ...
                <nav class="primary_nav primary_nav1 clearfix border_b_c">
                    <ul>
                            ...
                            <a href="index.php?r=task/count" ><span class="icon32 task_model">计件悬赏</span><em>计件悬赏</em><span class="arrow_b"></span></a>
                                                ...
                                                <li>
                            <a href="index.php?r=task/double" class="selected"><span class="icon32 task_model">多人悬赏</span><em>多人悬赏</em><span class="arrow_b"></span></a>
                        </li>
                                                <li>
      ...
      <div class="rowElem clearfix po_re">
          <label class="grid_8"><strong>交稿截止日期：</strong></label>
            <div class="grid_16 alpha">       
               <input name="txt_task_day"   onclick="showcalendar(event, this, 0)" size="25" value="" type="text" id="txt_task_day" title="预计的任务持续天数,当前预算允许最小天数为:1,最大截止时间： 天" msgArea="span_task_day" onkeyup="clearstr(this)"
